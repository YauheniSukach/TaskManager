...
export default class TasksGrid extends Component {
    ...
    const data = {
      lanes: [
        ...
        },
        {
          ...
          title: "In progress",
          label:
            cards.filter(item => item.state === "In progress").length || [],
        ...
        },
        {
          ...
          label:
            cards.filter(item => item.state === "Testing in progress").length ||
            [],
          cards:
            cards.filter(item => item.state === "Testing in progress") || []
        },
        {
          id: "lane5",
          title: "Completed",
  ...
  handleDragEnd = (
    ...
    TasksActions.updateTask(cardId, {
      state: state,
      startProgressAt: state === "lane2" || state === "lane4" || new Date()
    });
  };
      ...
      <Fragment>
        ...
        <div className="tasks-grid">
          <Board
            ...
            onCardDelete={this.onTaskDelete}
            onCardClick={this.onCardClick}
            className="tasks-grid__board"
            draggable
            data={data}
          />
        </div>
